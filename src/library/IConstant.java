...
public interface IConstant 
{
    ...
    public final String OVNI_IMAGE_COLOR_PATH = "/image/ovni (4).png";
    
    public final String SIGN_OFF = "Sign off";
    
    public final String MESSAGE_SIGN_OFF = "Are you sure to sign off?";
    
    public final String HOME_TEXT = "Home";
    ...
    public final int OREDER_WAIT = 10000;
}